...
if example == 1:
    ...
    summary = 'Unique States: ' + str(len(unique_states)) + '. ' + \
              'Observed correlations: ' + str(len(x))
    ...
    #
    #  Histogram Plots of correlation frequencies
    #
    ...
    plt.ylabel('Entity')
    plt.xlabel('Time')
    fig.suptitle('Entity correlations Plot')
    ...
    myMatrix = cm.CorrelationMatrix(json_file=filename)
    # myMatrix.print()
    ...
    cb.set_label("correlation Prabability", rotation=270, labelpad=15)
