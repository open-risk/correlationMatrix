...
# Generic is a Typical Credit Rating correlation Matrix with sever rating states and one absorbing (Default) state

print("> Load the generic correlation matrix")
...
print("> Display the calculated correlation matrix set")
T.print_matrix()
...
ax.grid(True)
plt.title("Credit Curves of Generic correlation Matrix")
