...
# library to create synthetic state correlation datasets
#
...
def exponential_correlations(statespace, n, sample, rate, data_format='Compact'):
    """
...
def markov_chain(statespace, correlationmatrix, n, timesteps):
    """
    ...
    :type correlationmatrix: The correlationMatrix to use for the simulation
    :param int n: The number of distinct entities to simulate
...
def long_format(statespace, correlationmatrix, n, timesteps):
    """
    ...
    for i in range(n):
        ...
        # the correlation probabilities for the initial state
        p = matrix[from_state]
        ...
        for k in range(1, timesteps):
            ...
            if to_state != from_state:
                ...
                # Calculate next correlation probabilities
                p = matrix[to_state]
                # Shift state
                from_state = to_state
